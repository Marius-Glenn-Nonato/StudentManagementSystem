...
public class TeacherMenu {
    ...
    public void showMenu() {
        ...
        System.out.println("║  Student #: " + String.format("%-31s", teacher.getTeacher_id()) + "║");
        System.out.println("╚═════════════════════════════════════════════╝");
        System.out.println();
        ...
        while (running) {
            ...
            System.out.println("3. Update Grades in a Class");
            System.out.println("4. Manage Attendance");
            System.out.println("5. View My Profile");
            System.out.println("6. Request Edit Profile");
